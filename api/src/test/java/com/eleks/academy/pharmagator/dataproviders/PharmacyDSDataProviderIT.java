...
class PharmacyDSDataProviderIT {

    private PharmacyDSDataProvider subject;

    private static MockWebServer mockWebServer;

    private final String BASE_URL = "https://apteka-ds.com.ua/catalog/preparaty-vid-hrvi-ta-zastudy/preparaty-vid-zastudy";
    ...
    void setUp() {
        ...
        subject = new PharmacyDSDataProvider(webClient);

        ReflectionTestUtils.setField(subject, "pagesLimit", 1);

        ReflectionTestUtils.setField(subject, "pharmacyDSBaseUrl", BASE_URL);
    }
    ...
    void loadData_ok() {
        ...
        assertEquals("DS", medicineDto.getPharmacyName());
    }
